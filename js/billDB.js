...
authStateChanged(async (user) => {
  if (user) {
    // User is authenticated, display expenses data
    console.log('User available:', user);
    displayExpenses();
  } else {
    // User is not authenticated, handle accordingly
    console.log("User not authenticated. Expenses data will not be displayed.");
  }
});
...
async function addExpense(type, monthlyCost, description) {
  ...
  if (user) {
    ...
    console.log('User not authenticated. Cannot add expense.');
  }
}
